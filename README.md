...
- [KeyShepherd](https://github.com/scale-tone/key-shepherd) - this VsCode extension takes care of credentials (secrets, access keys, connection strings etc.), which are typically spread across numerous config files on your devbox(es).
